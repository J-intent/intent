...
class Resolver:
    ...
    def _resolve_class_decl(self, stmt) -> None:
        """解析类声明"""
    ...
    def _resolve_expr(self, expr) -> None:
        ...
        from mini_intent import (
            ...
            MatchExpr, TryExpr, ThisExpr, SetExpr, GetExpr, ThisExpr, SetExpr, GetExpr,
